...
from TermTk.TTkWidgets import TTkWidget, TTkButton, TTkLabel, TTkWindow
...
def show_instructions(root):
    ...
    back_button = TTkButton(border=True, text="Zurück", maxWidth=20)
